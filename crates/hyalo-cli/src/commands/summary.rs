...
pub fn summary(
    ...
    let link_health = {
        ...
        // Count anchors independently of missing targets. The shared matcher
        // skips unresolved targets, so mixed vaults retain both findings without
        // double counting. None means the vault itself could not be checked.
        let broken_anchors =
