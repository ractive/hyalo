...
fn lookup_filter(key_sig: &str) -> Option<&'static str> {
    match key_sig {
        ...
        "ambiguous,ambiguous_links,applied,applied_fixes,broken,case_mismatch_fixes,case_mismatches,failed,failed_fixes,fixable,fixes,fuzzy,fuzzy_applied,fuzzy_fixes,fuzzy_min_confidence,ignored,out_of_vault,out_of_vault_links,templated,templated_links,unapplied,unapplied_fixes,unfixable,unfixable_links" => {
