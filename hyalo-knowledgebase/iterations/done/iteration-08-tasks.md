...
- Originally `--file` was required for all task commands (see [[decision-log#DEC-021: Tasks Are File-Scoped Only (2026-03-20) — SUPERSEDED]]). Iteration 9 added vault-wide and `--glob` support.
