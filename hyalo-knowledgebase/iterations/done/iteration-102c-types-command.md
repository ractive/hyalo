...
Add a `hyalo types` CLI for managing type schemas in `.hyalo.toml` without hand-editing TOML. Depends on **[[iterations/done/iteration-102a-schema-and-lint]]** for the schema data model. Independent of 102b (can ship in parallel).
