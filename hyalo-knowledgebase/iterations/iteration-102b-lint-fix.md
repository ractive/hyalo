...
> **Superseded by [[iterations/done/iteration-102c-types-command]]** — the `lint --fix` work in
...
Add auto-remediation to `hyalo lint`. Depends on **[[iterations/done/iteration-102a-schema-and-lint]]** — schema model, validation, and read-only `lint` must land first.
