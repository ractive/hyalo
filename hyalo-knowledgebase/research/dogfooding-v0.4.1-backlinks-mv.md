...
The `--dir` value (`../docs/content`) leaks into the rewritten link path. With an absolute `--dir` path it's even worse: `[text](/home/user/devel/docs/content/graphql/reference/all-objects#section)`.
