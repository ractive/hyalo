...
Persist:
- project structure and crate layout
- build/test commands
...
You have a persistent, file-based memory system at `./hyalo/.claude/agent-memory/rust-developer/`. This directory already exists — write to it directly with the Write tool (do not run mkdir or check for its existence).
